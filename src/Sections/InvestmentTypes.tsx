...
const INVESTMENT_TYPES = {
	GIC: {
		...
		body: (
			<div>
				...
				<ul>
					<li>
						Withdrawing your money before the specified time period may be impossible
						or subject to penalty.
						<br />
						Therefore, it's usually a good idea to use a High Interest Savings Account
						over a GIC if the interest is higher.
						<ul>
							<li>You can withdraw your money anytime.</li>
							<li>
								For example, the{' '}
								<a href="https://www.wealthsimple.com/en-ca/product/save/">
									Wealthsimple Savings Account
								</a>{' '}
								earns 2% interest per year.
							</li>
							<li>
								Note: Do a google search on High Interest Savings Accounts to find other
								rates
							</li>
						</ul>
					</li>
				...
				<VisualizationWrapper
					showKey={SessionState.showGIC}
					component={<GICVisualized />}
				/>
			</div>
		),
	},
	...
	FUND: {
		...
		body: (
			<div>
				A ETFs and mutual fund are collections of stocks. Heres how mutual funds
				differ from ETFs:
				<ul>
					<li>
						ETFs actively trade throughout the trading day while mutual fund trades
						close at the end of the trading day.
					</li>
				</ul>
				When choosing which ETF or mutual fund addresses your needs, please consider
				the fees.
				<ul>
					<li>
						<a href="https://dqydj.com/sp-500-historical-return-calculator/">
							The return of the {'S&P'} 500 over the last 30 years was about 9.5% with
							dividends reinvested. (Not accounting for inflation)
						</a>
					</li>
					<li>
						Past returns do not indicate future returns but for example sake, we will
						use these numbers.
					</li>
					<li>
						See the Fees Visualizer to understand how much money you could lose from
						just a 2% fee.
					</li>
				</ul>
				<VisualizationWrapper
					showKey={SessionState.showFees}
					component={<FeesVisualized />}
				/>
			</div>
		),
	},
