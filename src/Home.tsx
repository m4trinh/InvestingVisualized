...
const Home = () => 
    <div className="center-all">
        ...
        <h3>Explore different types of accounts, investments, and resources!</h3> <br/>
        <h4>Notable Visualizations: <br/>
        ...
        <p>Please note that this guide is targeted towards Canadians. The terminology may vary depending on your country</p>
    </div>
