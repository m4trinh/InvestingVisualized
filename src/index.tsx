...
const routing = (
    <Router>
      <nav className="navbar navbar-expand-lg navbar-light primary-color">
            <div className="navbar-brand"><Link to="/">Investing Visualized</Link></div>
        ...
        <div className="collapse navbar-collapse" id="navbarNavDropdown">
            <ul className="navbar-nav">
                <li className="nav-item">
                    <div className="nav-link"><Link to="/accounts">Accounts</Link></div>
                </li>
                <li className="nav-item">
                    <div className="nav-link"><Link to="/investments">Investments</Link></div>
                </li>
                <li className="nav-item">
                    <div className="nav-link"><Link to="/brokers">Brokers</Link></div>
                </li>
                <li className="nav-item">
...
ReactDOM.render(<Authentication>{routing}</Authentication>, 
