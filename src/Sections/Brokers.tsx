...
const BROKER_TYPES = [
	{
										...
										<td>
											...
											<p>
												...
												<a
													...
													href="https://questrade-support.secure.force.com/mylearning/view/b/Account/Inactivity-fees/"
												>
													{' '}
													waived
												</a>
		...
		note: (
			<React.Fragment>
				<a href="">ECN fees</a> may be adding on to each trade.
			</React.Fragment>
		),
	},
	{
				...
				<table className="table">
					...
					<tbody>
						...
						<tr>
							<td>ETF</td>
							{BROKER_TYPES.map(x => (
								<td>{x.tradingFees.etf}</td>
							))}
						</tr>
						<tr>
							<td>Stock</td>
							{BROKER_TYPES.map(x => (
								<td>{x.tradingFees.stock}</td>
							))}
						</tr>
						<tr>
							<td>Option Contract</td>
							{BROKER_TYPES.map(x => (
								<td>{x.tradingFees.option}</td>
							))}
						</tr>
					</tbody>
				</table>
