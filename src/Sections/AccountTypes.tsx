...
const ACCOUNT_TYPES = {
    TFSA: {
        ...
        <div>
            ...
            <ul>
                ...
                <ul>
                    <li>The Canadian government adds more contribution room every year (On January 1st)</li>
                    <li>Depositing money into a TFSA deducts your contribution room.</li>
                    <li>Withdrawing money from your TFSA readds the capital to your contribution room next year.</li>
                </ul>
            </ul>
            See the Contribution Room Calculator for a visualization of contribution room!
            <hr />
            <VisualizationWrapper showKey={SessionState.showTFSA} component={<TFSAVisualized />}/>
        </div>
        ...
        <div>
            ...
            <ul>
                ...
                <ul>
                    ...
                    <li>All investment earnings ({EAP_ABBREV}s) and {CESG_ABBREV} are paid to your child (Usually split throughout the duration of post secondary)</li>
                    <ul>
                        <li>These payments are taxable</li>
                        <li>Post Secondary Students usually have none or little income so the tax can be offset by tuition credits</li>
                        <li>If you anticipate your child potentially doing an internship at Microsoft (or some other company that pays interns large sums of money), it may be wise to withdraw the bulk of the RESP early to avoid money being taxed in a higher tax bracket</li>
                    </ul>
            ...
            <hr />
            <VisualizationWrapper showKey={SessionState.showRESP} component={<RESPVisualized />}/>
        </div>
    },
    RRSP: {
        ...
        <div>
            ...
            <ul>
                ...
                <li>Withdrawing money forfeits contribution space.
                <br />
    ...
    MARGIN: {
        ...
        titleHyperlink: "https://www.investopedia.com/ask/answers/100314/whats-difference-between-cash-account-and-margin-account.asp",
        body: 
        <div>
            <ul>
                <li>Margin accounts are used to borrow money to trade stocks</li>
                <li>Beginners should stay away from these accounts because it adds more risk</li>
                <li>Although, margin accounts may amplify gains, it will also amplify losses!</li>
            </ul>
        </div>
    }
};
